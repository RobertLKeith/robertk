<script>
import {onMount} from "svelte"; import Seo from "./components/Seo.svelte"; import Hero from "./components/Hero.svelte"; import Gallery from "./components/Gallery.svelte"; import GalleryOnSet from "./components/GalleryOnSet.svelte"; import Showreel from "./components/Showreel.svelte"; import Credits from "./components/Credits.svelte"; import Testimonials from "./components/Testimonials.svelte"; import {profile,agency,showreels,seo} from "./data/profile"; import {credits} from "./data/credits"; import {testimonials} from "./data/testimonials";
const resumeUrl="./Robert-Keith-Resume.pdf";
import eamLogo from "./assets/other/EAM.avif";
...
<Seo {seo} {profile}/><Hero {profile} {agency} {heroImage} {resumeUrl} hasShowreels={availableReels.length > 0}/><main>
...
<section id="credits" class="section"><div class="container"><header class="section-head" data-reveal><div><p class="eyebrow">Résumé</p><h2>Credits</h2></div></header><Credits {credits}/><div class="link-row" data-reveal><a href={resumeUrl} download="Robert-Keith-Resume.pdf">Download full resume ↓</a><a href={profile.imdbUrl} target="_blank" rel="noopener noreferrer">IMDb ↗</a><a href={profile.actorsAccessUrl} target="_blank" rel="noopener noreferrer">Actors Access ↗</a></div></div></section>
